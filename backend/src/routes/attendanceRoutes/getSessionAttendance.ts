...
import { getLiveSession, getLiveSessionAttendance, isLiveSession } from "../../utils/sessionRedis";

const getSessionAttendance = async (req: Request, res: Response) => {
  try {
    ...
    if (isLive) {
      ...
      // Check access permissions (students can view their own attendance)
      ...
      return sendSuccessResponse(res, {
        sessionId: id,
        attendance,
        isFinalized: liveSession.isFinalized,
      });
    }
